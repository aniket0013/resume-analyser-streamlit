...
def pdf_reader(file): #iterates through all pages of PDF's and extracts plain text
...
def insert_data(name, email, res_score, timestamp, no_of_pages, reco_field, cand_level, skills, recommended_skills,
    ...
    # Truncate or abbreviate 'actual_skills' if its length exceeds the column limit
    if len(skills) > 300:
        skills = skills[:300]
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                if 'name' in resume_data and resume_data['name'] is not None:
                    ...
                    st.warning("Name not found in resume data")
                #st.success("Hello " + resume_data['name'])
                if 'email' in resume_data and resume_data['email'] is not None:
                    pass
                else:
                    resume_data['email']="email not found"
